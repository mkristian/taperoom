...
#
# can not help to write: these kind of fixes should not be neccesary !!!!
require 'thread' # http://stackoverflow.com/questions/5176782/uninitialized-constant-activesupportdependenciesmutex-nam

ENV['GEM_HOME']='/home/taperoom/rubygems'
